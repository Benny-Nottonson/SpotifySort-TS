...
import { Application as gr } from "./customSplineRuntime/build/runtime";
var Z =
    typeof globalThis < "u"
      ? globalThis
      : typeof window < "u"
...
function hr() {
  ...
  function _(d, c, T) {
    ...
    T !== void 0 && (O = "" + T),
      ...
      c.ref !== void 0 && (C = c.ref);
    for (v in c) E.call(c, v) && !j.hasOwnProperty(v) && (b[v] = c[v]);
    if (d && d.defaultProps)
      for (v in ((c = d.defaultProps), c)) b[v] === void 0 && (b[v] = c[v]);
    return {
      $$typeof: f,
      type: d,
      key: O,
    ...
    We ||
      ...
      process.env.NODE_ENV !== "production" &&
        (function () {
          ...
          function D(e, r, t) {
            {
              var a = y.ReactDebugCurrentFrame,
...
` + i[g].replace(" at new ", " at ");
          ...
          function K(e, r, t) {
            if (e == null) return "";
            if (typeof e == "function") return Re(e, Ke(e));
          ...
          function X(e) {
            if (e) {
              var r = e._owner,
                t = K(e.type, e._source, r ? r.type : null);
          ...
          function ur(e, r, t, a, u) {
            {
              var l,
                ...
                w = null;
              t !== void 0 && (Oe(t), (i = "" + t)),
                tr(r) && (Oe(r.key), (i = "" + r.key)),
                rr(r) && ((w = r.ref), nr(r, u));
              for (l in r)
                H.call(r, l) && !er.hasOwnProperty(l) && (o[l] = r[l]);
              if (e && e.defaultProps) {
                var g = e.defaultProps;
                for (l in g) o[l] === void 0 && (o[l] = g[l]);
              }
              if (i || w) {
                var h =
                  typeof e == "function"
          ...
          var ae = y.ReactCurrentOwner,
            Ce = y.ReactDebugCurrentFrame;
          function N(e) {
            if (e) {
              var r = e._owner,
                t = K(e.type, e._source, r ? r.type : null);
          ...
          function ke(e, r) {
            {
              ...
              e &&
                e._owner &&
                e._owner !== ae.current &&
                (a = " It was passed a child from " + W(e._owner.type) + "."),
                N(e),
                s(
          ...
          function Fe(e, r, t, a, u, l) {
            {
              ...
              if (o) {
                ...
                if (k !== void 0)
                  if (a)
                    if (te(k)) {
                      for (var M = 0; M < k.length; M++) Ae(k[M], e);
...
var Rr = "Expected a function",
  ...
  wr = /^0o[0-7]+$/i,
  jr = parseInt,
  Cr = typeof Z == "object" && Z && Z.Object === Object && Z,
  Pr = typeof self == "object" && self && self.Object === Object && self,
  xr = Cr || Pr || Function("return this")(),
  kr = Object.prototype,
  Ar = kr.toString,
  Fr = Math.max,
  Ir = Math.min,
...
function Dr(n, f, m) {
  var E,
    ...
    b = !1,
    O = !0;
  if (typeof n != "function") throw new TypeError(Rr);
  (f = Le(f) || 0),
    le(m) &&
      ((v = !!m.leading),
      (b = "maxWait" in m),
      (j = b ? Fr(Le(m.maxWait) || 0, f) : j),
      (O = "trailing" in m ? !!m.trailing : O));
  function C(p) {
    var I = E,
      L = R;
  ...
  function S() {
    ...
    if (((E = arguments), (R = this), (c = p), I)) {
      if (d === void 0) return A(c);
      if (b) return (d = setTimeout(y, f)), C(c);
    }
...
const Nr = [],
  ...
  Ur = Ne(function (
    ...
    return (
      Ue(() => {
        const F = d || window.ResizeObserver,
          P = new F((y) => {
            y.forEach((s) => {
              const {
                left: D,
      ...
      return (
        Ue(() => {
          ...
          if (F.current) {
            ...
            async function x() {
              await s.load(n);
              for (let S of D) S.cb && s.addEventListener(S.name, S.cb);
              y(!1), b == null || b(s);
            }
            x();
          }
          return () => {
            for (let x of D) x.cb && s.removeEventListener(x.name, x.cb);
            s.dispose();
          };
        }, [n]),
        /* @__PURE__ */ ce(Ur, {
