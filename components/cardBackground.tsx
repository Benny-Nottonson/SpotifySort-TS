...
export default function CardBackground({ className }: Props) {
    return (
        <div className={`w-full h-full rounded-full ${className}`} style={{ borderRadius: "1.5rem", overflow: "hidden"}}>
            ...
            <div style={{ position: "absolute", top: 0, left: 0, width: "100vw", height: "100vh", opacity:.2}}>
