  ...
  function AnimatedCircle({ delay, direction, velocity, distance, position, ...props }: AnimatedCircleProps) {
    ...
    useEffect(() => {
      ...
      timeline.from(meshRef.current!.scale, {
        x: 0,
        y: 0,
        z: 0,
    ...
    }, [delay, distance, startPosition, targetPosition, velocity]);
  ...
  function Scene({ ...props }) {
    const { nodes, materials } = useSpline('https://prod.spline.design/RBSwFfmfPdDv-eOh/scene.splinecode')
    return (
      <>
