    ...
    return (
      <div className="flex items-center justify-center m-4">
        <div className="relative max-w-3xl min-w-full bg-white bg-opacity-40 border-1 border-white border-opacity-15 rounded-lg shadow-xl backdrop-filter backdrop-blur-lg p-4">
          <div className="flex">
            <div className="relative h-64 w-64 mr-4 bg-gray-200 rounded-lg"></div>
            <div className="flex flex-col justify-between">
              <div>
                <ul className="text-white space-y-1">
                  <li className="truncate bg-gray-200 h-4 w-1/2 mb-1 rounded"></li>
                  <li className="truncate bg-gray-200 h-4 w-3/4 mb-1 rounded"></li>
                  <li className="truncate bg-gray-200 h-4 w-1/2 mb-1 rounded"></li>
                  <li className="truncate bg-gray-200 h-4 w-3/4 mb-1 rounded"></li>
                  <li className="truncate bg-gray-200 h-4 w-1/2 mb-1 rounded"></li>
                </ul>
              ...
              <div className="flex justify-end items-end mt-4">
                <p className="text-gray-400 text-sm">Playlist Length: <br />-- minutes</p>
                <button
