...
import { createElementNS } from './three-utils';
...
class WebGLRenderer {
	...
	constructor( parameters = {} ) {
		...
		try {
			...
			if ( 'setAttribute' in canvas ) canvas.setAttribute( 'data-engine', `three r${REVISION}` );
		...
		function setProgram( camera, scene, geometry, material, object ) {
			...
			// https://github.com/mrdoob/three/pull/24467#issuecomment-1209031512
